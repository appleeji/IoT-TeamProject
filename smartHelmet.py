...
#print "gyro_zout: ", gyro_zout, " scaled: ", (gyro_zout / 131)
	...
	if math.sqrt(pow(accel_xout_scaled_prev - accel_xout_scaled,2)+pow(accel_yout_scaled_prev - accel_yout_scaled,2)+pow(accel_zout_scaled_prev - accel_zout_scaled,2)) < 1000 :
		continue
			...
			if waitCount > 100 :
				...
				with tf.Session() as sess:
					...
					while True:
						...
						if countGps > 100 :
							break
						if not msg.lat or msg.lon :
							continue
						else :
							#step8 publis gps value 
							mqttc.loop_start()
							msg = 'a'+mat.lon+mat.lat
							mqttc.publis("accident",msg)	
							mqttc.loop_stop()				
							break
